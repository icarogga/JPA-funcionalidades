package com.icarogga.aulajparepository.repositories;
...
import com.icarogga.aulajparepository.entities.User;
...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query("SELECT obj FROM User obj WHERE LOWER(name) LIKE LOWER(CONCAT('%', :name, '%'))")
